...
namespace API.Migrations
{
    ...
    [Migration("20190512210748_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Data.CodeCamp.Entities.Camp", b =>
                {
            ...
            modelBuilder.Entity("API.Data.CodeCamp.Entities.Location", b =>
                {
                    b.Property<int>("LocationId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("API.Data.CodeCamp.Entities.Speaker", b =>
                {
            ...
            modelBuilder.Entity("API.Data.CodeCamp.Entities.Talk", b =>
                {
            ...
            modelBuilder.Entity("API.Data.CodeCamp.Entities.Camp", b =>
                {
                    b.HasOne("API.Data.CodeCamp.Entities.Location", "Location")
                        .WithMany()
            ...
            modelBuilder.Entity("API.Data.CodeCamp.Entities.Talk", b =>
                {
                    b.HasOne("API.Data.CodeCamp.Entities.Camp", "Camp")
                        .WithMany("Talks")
                        .HasForeignKey("CampId");

                    b.HasOne("API.Data.CodeCamp.Entities.Speaker", "Speaker")
                        .WithMany()
